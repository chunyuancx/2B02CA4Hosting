...
function getQueueApi(trackerId) {
    ...
    setTimeout(function () {
        ...
        fetch('https://cheng-chun-yuan-ades-ca1.herokuapp.com/company/queue?company_id=' + companyId)
...
function getGraphData(queueid, trackerId) {
    ...
    fetch(`https://cheng-chun-yuan-ades-ca1.herokuapp.com/company/arrival_rate?queue_id=${queue_id}&from=${time}&duration=3`)
